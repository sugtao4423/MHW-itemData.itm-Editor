...
data class ItemData(val uByte32Array: UByteArray) {
    ...
    var id: Int
        get() {
            return ubyteArrayOf(uByte32Array[0], uByte32Array[1]).let {
                ItmFileUtils.itmFileByteFormat2Int(it)
            }
        }
        set(value) {
            ItmFileUtils.int2ItmFileByteFormat(value, 2).mapIndexed { index: Int, uByte: UByte ->
    ...
    var sell: Int
        ...
        set(value) {
            ItmFileUtils.int2ItmFileByteFormat(value, 4).mapIndexed { index: Int, uByte: UByte ->
